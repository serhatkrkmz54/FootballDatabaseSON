package db.footballdb.football_d_b_mongo.util;

import static db.footballdb.football_d_b_mongo.util.MongoOffsetDateTimeWriter.DATE_FIELD;
import static db.footballdb.football_d_b_mongo.util.MongoOffsetDateTimeWriter.OFFSET_FIELD;
