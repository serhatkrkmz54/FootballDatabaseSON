...
```
java -Dspring.profiles.active=production -jar ./target/FootballDBMongo-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=db.footballdb/football-d-b-mongo
```
